...
- [x] [s02t11](s02t11-rename-installed-skills-on-source.md): Rename installed skills on source rename
- [x] [s02t12](s02t12-pinned-branch-in-source-init/): Pinned branch in `source init` + remove `--any-branch`
- [ ] s02t13: Release v1.0
