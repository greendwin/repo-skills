...
- [ ] [s06t0601](s06t0601-extract-shared-helpers-from-mergepy.md): Extract shared helpers from _merge.py
- [ ] [s06t0602](s06t0602-basic-diff-command-for-tracked.md): Basic diff command for tracked modified skill
- [ ] [s06t0603](s06t0603-edge-cases-not-modified-addeddeleted.md): Edge cases: not modified, added/deleted files, errors
