...
- [~] [s06t1601](s06t1601-attach-a-uniquelymatching-untracked-skill.md): **review** Attach a uniquely-matching untracked skill
- [~] [s06t1602](s06t1602-attach-ambiguity-handling-filter-integration.md): **review** Attach ambiguity handling & filter integration
- [~] [s06t1603](s06t1603-attach-refactor-filterscoped-pullattach-semantics.md): **review** Attach refactor + filter-scoped pull/attach semantics
