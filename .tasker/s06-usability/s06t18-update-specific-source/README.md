...
- [~] [s06t1801](s06t1801-extract-targetskill-collection-as-a.md): **review** Extract target-skill collection as a seam
- [~] [s06t1802](s06t1802-ssource-filters-the-update-work.md): **review** `-s/--source` filters the update work set
- [~] [s06t1803](s06t1803-derive-pulls-from-the-collected.md): **review** Derive pulls from the collected skill set
