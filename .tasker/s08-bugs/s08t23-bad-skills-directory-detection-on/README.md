...
- [ ] [s08t2302](s08t2302-depthfree-detection-with-threecase-contract.md): Depth-free detection with three-case contract
...
- [ ] [s08t2308](s08t2308-resolve-broken-source-json-handling.md): Resolve broken source.json handling (duplicate message / fatal-vs-graceful)
- [ ] [s08t2309](s08t2309-move-v0-migration-off-sourceconfig.md): Move v0 migration off SourceConfig into a dedicated _SourceConfigV0 model
