...
- [ ] [s02t01](s02t01-remove-unused-commands.md): Remove unused commands
- [ ] [s02t02](s02t02-new-config-and-manifest-models.md): New config and manifest models
- [ ] [s02t03](s02t03-skills-source-init.md): `skills source init`
