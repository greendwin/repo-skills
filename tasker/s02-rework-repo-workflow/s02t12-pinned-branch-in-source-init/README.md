...
- [ ] [s02t1201](s02t1201-resolvebranch-function-sourceconfigbranch-field.md): `resolve_branch` function + `SourceConfig.branch` field
- [ ] [s02t1202](s02t1202-source-init-writes-current-branch.md): `source init` writes current branch + `--branch` flag
